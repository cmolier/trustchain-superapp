...
class TransactionTest {
    ...
    fun invalidBankSignature() {
        ...
        val invalidEuro = DigitalEuro(firstEuro.serialNumber, firstEuro.firstTheta1, fakeSignature, firstEuro.proofs, firstEuro.ephemeralKeySignatures)
        val invalidWalletEntry = WalletEntry(invalidEuro, walletEntry.t, walletEntry.transactionSignature, walletEntry.timesSpent, walletEntry.ephemeralPrivateKey)
        ...
        val fakeEuro = DigitalEuro(firstEuro.serialNumber, firstEuro.firstTheta1, secondEuro.signature, firstEuro.proofs, firstEuro.ephemeralKeySignatures)
        val fakeWalletEntry = WalletEntry(fakeEuro, walletEntry.t, walletEntry.transactionSignature, walletEntry.timesSpent, walletEntry.ephemeralPrivateKey)
        ...
        val invalidTWalletEntry = WalletEntry(walletEntry.digitalEuro, invalidT, walletEntry.transactionSignature, walletEntry.timesSpent, walletEntry.ephemeralPrivateKey)
